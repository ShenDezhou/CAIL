...
class BertSupportNetX(nn.Module):
    ...
    def __init__(self, config):
        ...
        if self.input_dim == 1024:
            ...
            self.W_doc = nn.Parameter(torch.FloatTensor(36736, self.num_compressed_capsule))
    ...
    def forward(self, context_idxs, context_mask, segment_idxs,
        ...
        return start_logits, end_logits, type_logits, None, start_position, end_position
