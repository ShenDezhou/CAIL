    ...
    for case in tqdm(full_data):   # 遍历每个样本
        ...
        for paragraph in para_data:  # 选中的段落
            ...
            for local_sent_id, sent in enumerate(sents):  # 处理段落的每个句子
                ...
                if len(doc_tokens) >= 430:   # 如果大于382个词则break
...
if __name__ == '__main__':
    ...
    parser.add_argument("--example_output", default='data_model/train_example.pkl', required=False, type=str)
    parser.add_argument("--feature_output", default='data_model/train_feature.pkl', required=False, type=str)
