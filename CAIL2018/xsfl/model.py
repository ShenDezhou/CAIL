...
class BertForClassification(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, token_type_ids):
        ...
        pooled_output = torch.mean(bert_output[0], dim=1)
...
class CharCNN(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.conv2 = nn.Conv1d(num_conv_filters, num_conv_filters, kernel_size=5)
        ...
        self.conv5 = nn.Conv1d(num_conv_filters, output_channel, kernel_size=3)
